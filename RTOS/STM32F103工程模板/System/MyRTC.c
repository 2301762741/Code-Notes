...
uint16_t MyRTC_Time[] = {2024, 4, 11, 21, 42, 0};	//定义全局的时间数组，数组内容分别为年、月、日、时、分、秒
...
{
//	OLED_ShowString(2, 1, "Date:XXXX-XX-XX");    //显示时间格式放int中了
//	OLED_ShowString(3, 1, "Time:XX:XX:XX");
	...
	//OLED_ShowNum(4, 6, RTC_GetCounter(), 10);	//显示32位的秒计数器
	//OLED_ShowNum(5, 6, RTC_GetDivider(), 10);	//显示余数寄存器
}
